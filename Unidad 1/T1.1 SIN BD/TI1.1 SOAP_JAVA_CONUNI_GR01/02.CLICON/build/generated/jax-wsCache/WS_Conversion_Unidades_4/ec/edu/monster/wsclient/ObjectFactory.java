 ...
 * generated in the ec.edu.monster.wsclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _MetrosApiesResponse_QNAME = new QName("http://ws.monster.edu.ec/", "metrosApiesResponse");
    ...
    private final static QName _KilometrosAmillas_QNAME = new QName("http://ws.monster.edu.ec/", "kilometrosAmillas");
    private final static QName _GramosAonzasResponse_QNAME = new QName("http://ws.monster.edu.ec/", "gramosAonzasResponse");
    private final static QName _GramosAonzas_QNAME = new QName("http://ws.monster.edu.ec/", "gramosAonzas");
    private final static QName _MetrosApies_QNAME = new QName("http://ws.monster.edu.ec/", "metrosApies");
    ...
    private final static QName _KilometrosAmillasResponse_QNAME = new QName("http://ws.monster.edu.ec/", "kilometrosAmillasResponse");
    private final static QName _KilogramosAlibras_QNAME = new QName("http://ws.monster.edu.ec/", "kilogramosAlibras");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.edu.monster.wsclient
     * 
     */
    ...
    /**
     * Create an instance of {@link KilometrosAmillas }
     * 
     */
    public KilometrosAmillas createKilometrosAmillas() {
        return new KilometrosAmillas();
    }

    /**
     * Create an instance of {@link GramosAonzasResponse }
     * 
     */
    public GramosAonzasResponse createGramosAonzasResponse() {
        return new GramosAonzasResponse();
    }

    /**
     * Create an instance of {@link GramosAonzas }
     * 
     */
    public GramosAonzas createGramosAonzas() {
        return new GramosAonzas();
    }
    ...
    /**
     * Create an instance of {@link KilometrosAmillasResponse }
     * 
     */
    public KilometrosAmillasResponse createKilometrosAmillasResponse() {
        return new KilometrosAmillasResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "metrosApiesResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link KilometrosAmillas }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "kilometrosAmillas")
    public JAXBElement<KilometrosAmillas> createKilometrosAmillas(KilometrosAmillas value) {
        return new JAXBElement<KilometrosAmillas>(_KilometrosAmillas_QNAME, KilometrosAmillas.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GramosAonzasResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "gramosAonzasResponse")
    public JAXBElement<GramosAonzasResponse> createGramosAonzasResponse(GramosAonzasResponse value) {
        return new JAXBElement<GramosAonzasResponse>(_GramosAonzasResponse_QNAME, GramosAonzasResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link GramosAonzas }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "gramosAonzas")
    public JAXBElement<GramosAonzas> createGramosAonzas(GramosAonzas value) {
        return new JAXBElement<GramosAonzas>(_GramosAonzas_QNAME, GramosAonzas.class, null, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "metrosApies")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link KilometrosAmillasResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://ws.monster.edu.ec/", name = "kilometrosAmillasResponse")
    public JAXBElement<KilometrosAmillasResponse> createKilometrosAmillasResponse(KilometrosAmillasResponse value) {
        return new JAXBElement<KilometrosAmillasResponse>(_KilometrosAmillasResponse_QNAME, KilometrosAmillasResponse.class, null, value);
    }
